...
namespace NanoCell.Infrastructure.Services
{
    ...
    public class EmailService : IEmailService
    {
        ...
        public async Task<Result> ReceiveMailImapAsync()
        {
        ...
        public async Task<Result> ReceiveMailPopAsync(int min = 0, int max = 0)
        {
        ...
        public async Task<Result> SendEmailAsync(EmailMessageDto emailMessage)
        {
            try
            {
